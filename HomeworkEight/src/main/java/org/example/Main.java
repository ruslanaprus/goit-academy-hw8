...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nRECTANGLE INFO\n");
        ShapeComposer rectangle = new Rectangle(new int[]{0, 0, 0, 1, 2, 1, 2, 0});
        ...
        System.out.println("(rectangle.getAngles(rectangle.getPoints()) = " + Arrays.toString(rectangle.getAngles(rectangle.getPoints())));
        rectangle.printSidesLength();

        System.out.println("\nTRIANGLE INFO\n");
        ShapeComposer triangle = new Triangle(new int[]{0, 0, 0, 1, 2, 0});
        ...
        System.out.println("triangle.getAngles(triangle.getPoints()) = " + Arrays.toString(triangle.getAngles(triangle.getPoints())));
        triangle.printSidesLength();

        System.out.println("\nPARALLELOGRAM INFO\n");
        ShapeComposer parallelogram = new Parallelogram(new int[]{0, 0, 1, 2, 4, 2, 3, 0});
        ...
        System.out.println("parallelogram.getAngles(parallelogram.getPoints()) = " + Arrays.toString(parallelogram.getAngles(parallelogram.getPoints())));
        parallelogram.printSidesLength();

        System.out.println("\nCIRCLE INFO\n");
        ShapeComposer circle = new Circle(new int[]{3, 2, 3, -1, 0, 2});
        ...
        System.out.println("\nPENTAGON INFO\n");
        ShapeComposer pentagon = new Pentagon(new int[]{1, -1, 1, 3, 5, 3, 7, -1, 3, -3});
        ...
        System.out.println("pentagon.getAngles(pentagon.getPoints()) = " + Arrays.toString(pentagon.getAngles(pentagon.getPoints())));
